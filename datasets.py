...
class UADFVDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.method == 'resnet_lstm' or self.method == 'efficientnetb1_lstm' or self.method == 'transformer' or self.method == '3dcnn':
            imgs = []
...
class FaceForensicsDataset(Dataset):
    """
       FaceForensics++ Dataset from Andreas Rossler, Davide Cozzolino, Luisa Verdoliva,
        Christian Riess, Justus Thies, Matthias Niessner}
       (https://arxiv.org/abs/1901.08971)

       Adaption: Paloma Cantero Arjona over Cristopher's Otto implementation
    """
